...
.. figure:: ../../design/virelay-ui.png
    :alt: Screenshot of the ViRelAy UI in Both Light and Dark Mode
    :align: center

    Figure 1: A screenshot of the ViRelAy user interface in both light and dark mode.
...
* **User Guide** -- In-depth information about all features of ViRelAy, including analysis techniques for classifiers and datasets, as well as usage examples.
