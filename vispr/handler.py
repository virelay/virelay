...
def modify_doc(doc, original_path, attribution_path, analysis_path, wordmap_path, wnid_path):
    ...
    visual_rend = visual_fig.scatter('x', 'y', source=sample_src, size=6, color=visual_cmap,  # noqa: F841
    ...
    attribution_rend = image_fig.image('attribution', x='x', y='y', dw=wid, dh=hei, source=image_src,
                                       palette='Magma256', global_alpha=0.0)
    original_rend = image_fig.image_rgba('original', x='x', y='y', dw=wid, dh=hei, source=image_src,
                                         global_alpha=1.0)
